...
describe("application review test suite", () => {
    ...
    // const html = fs.readFileSync("./application-review.test.html");
    const testHtml = `<div></div>`;
    // const page = new JSDOM(html);

    beforeEach(() => {
        console.log(addUI(testHtml));
        console.log(page.window.document.body.innerHTML);

        const page = new jsdom.JSDOM(testHtml);
        console.log(page.window.document.body.innerHTML);
    ...
    // describe("rejection buttons test suite", () => {
    //     let handleRejectClickMock;
    //     beforeEach(() => {
    //         handleRejectClickMock = jest.fn(handleRejectClick);

    //         document
    //             .querySelectorAll(".rejection__button[data-reason]")
    //             .forEach((rejectionButton) => {
    //                 rejectionButton.addEventListener(
    //                     "click",
    //                     handleRejectClickMock
    //                 );
    //             });
    //     });
    // });
